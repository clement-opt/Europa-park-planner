...
export const RIDES: Ride[] = [
  ...
  { id: 5738, n: "Madame Freudenreich", z: "France", lat: 48.263, lng: 7.7183, dur: 8, thr: 0, nau: 0, k: "freudenreich", why: "Parcours scénique loufoque chez les dinosaures gourmands.", plus: "Le second degré assumé, un régal pour les yeux quand on prend le temps." },
  { id: 6280, n: "Eurosat Coastiality (VR)", z: "France", lat: 48.2636, lng: 7.7195, dur: 5, thr: 3, nau: 5, k: "coastiality", why: "Le même coaster, mais casque de réalité virtuelle sur la tête.", plus: "Sensations décuplées, estomac prévenu : c'est le brassage maximum du parc." },
  ...
  { id: 5614, n: "Whale Adventures", z: "Islande", lat: 48.2682, lng: 7.7196, dur: 6, thr: 1, nau: 0, k: "whale", why: "Balade aquatique sur le thème des baleines, très douce.", plus: "Le refuge parfait quand le compteur de brassage est dans le rouge." },
  { id: 13349, n: "Voltron Nevera", z: "Croatie", lat: 48.2688, lng: 7.7253, dur: 5, thr: 5, nau: 4, vl: true, vlId: 13504, k: "voltron", why: "La nouveauté lourde : multi-lancements et inversions.", plus: "La sensation de vitesse la plus moderne du parc, finitions comprises." },
  ...
  { id: 5631, n: "Jim Button", z: "Allemagne", lat: 48.2639, lng: 7.7228, dur: 8, thr: 0, nau: 0, k: "jim knopf", why: "Parcours scénique tiré du conte allemand, très soigné.", plus: "Les décors ; c'est l'attraction qu'on ne fait pas et qu'on regrette." },
  ...
  { id: 5629, n: "Vienna Wave Swing", z: "Autriche", lat: 48.2656, lng: 7.7245, dur: 4, thr: 2, nau: 3, k: "glückspilz", why: "Chaises volantes en hauteur, rotation ample.", plus: "La vue circulaire sur le quartier autrichien pendant la rotation." },
  { id: 5624, n: "Josefina's Magical Journey", z: "Autriche", lat: 48.2653, lng: 7.7256, dur: 7, thr: 0, nau: 0, k: "josefina", why: "Parcours scénique musical, tout en douceur.", plus: "L'attraction refuge du quartier. Zéro brassage, décor charmant." },
  ...
  { id: 5626, n: "Tractor Fun", z: "Irlande", lat: 48.2666, lng: 7.7259, dur: 4, thr: 0, nau: 0, kid: true, k: "traktor", why: "Parcours de tracteurs pour les plus jeunes.", plus: "Sans intérêt pour un groupe d'adultes, sauf pour la photo." }
];
